...
\begin{frame}{Desafíos de Detección en Selva Densa}
  \begin{itemize}
    \item \textbf{Densidad del dosel:} La densa selva misionera bloquea la vista de los drones, forzando la vigilancia a nivel del suelo. Bajo el dosel, la vegetación impide líneas de visión amplias para las cámaras trampa.
    \item \textbf{Área de cobertura reducida:} Cada cámara vigila una zona estrecha de pocos metros en línea recta, facilitando que los intrusos las esquiven.
  \end{itemize}
  \note{Cámaras trampa son el método más utilizado. La selva misionera presenta desafíos únicos: el dosel denso bloquea la vista de drones y la vegetación reduce el área de cobertura de las cámaras, haciendo que sea fácil para los intrusos evadirlas.}
\end{frame}
