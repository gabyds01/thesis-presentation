...
\centering
% TODO: Reemplazar el fbox con \includegraphics[width=0.8\textwidth]{ruta_imagen}
\fbox{\parbox{0.9\textwidth}{\centering\vspace{1.5cm}
    [Render carcasa o Esquemático KiCad Horizontal]
\vspace{1.5cm}}}
...
\end{column}
\begin{column}{0.5\textwidth}
% TODO: Diagrama Mesh Tree Topology (de User_Guide.md)
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}
    [Diagrama Mesh-Lite Tree Topology]
\vspace{2cm}}}
\end{column}
\end{columns}
\note{
