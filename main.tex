...
\begin{frame}{Aplicaciones de la IA en la Conservación}
  ...
  \begin{description}
    ...
    \item[MegaDetector / SpeciesNet:] Modelos específicos para fauna.
  \end{description}
  \note{
    ...
    iniciativa WildLife, y existen modelos robustos como YOLO, MegaDetector y
    SpeciesNet que automatizan la revisión de imágenes.
  }
\end{frame}
